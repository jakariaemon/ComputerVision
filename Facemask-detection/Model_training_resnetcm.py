...
testbatch = ImageDataGenerator(preprocessing_function=preprocess_input).flow_from_directory(
    directory="dataset/test",
    target_size=(224,224),
    batch_size=2,
    shuffle=False
)
model.evaluate(testbatch,verbose=1,steps=250)
